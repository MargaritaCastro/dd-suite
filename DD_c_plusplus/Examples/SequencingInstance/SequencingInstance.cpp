...
SequencingInstance::SequencingInstance(const string& file_path) {
    read_file(file_path);
}

void SequencingInstance::read_file(const string& file_path) {
    ...
    initial_state = new SequencingState{{}, -1};
}
