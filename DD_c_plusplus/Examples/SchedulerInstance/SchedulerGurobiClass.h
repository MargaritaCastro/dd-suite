#ifndef DD_OPTIMIZATION_PROGRAM_SCHEDULERGUROBICLASS_H
#define DD_OPTIMIZATION_PROGRAM_SCHEDULERGUROBICLASS_H
 ...
 */
class SchedulerGurobiClass : public AbstractProblemGurobi {
public:
    explicit SchedulerGurobiClass(const SchedulerInstance& params, bool continuous = false);

    void optimize_with_cuts(vector<DD<SchedulerState>*> dds,
...
#endif //DD_OPTIMIZATION_PROGRAM_SCHEDULERGUROBICLASS_H
