...
Graph<dynamic_bitset<>>* GetExactDDIndependentSet() {
...
Graph<dynamic_bitset<>>* GetReduceDDIndependentSet() {
    Node<dynamic_bitset<>>* node_0 = new Node<dynamic_bitset<>>(0, new dynamic_bitset<>(string("11111")));
    Graph<dynamic_bitset<>>* graph = new Graph(node_0);
...
Graph<dynamic_bitset<>>* GetRestrictedDDIndependentSet() {
    Node<dynamic_bitset<>>* node_0 = new Node<dynamic_bitset<>>(0, new dynamic_bitset<>(string("11111")));
    Graph<dynamic_bitset<>>* graph = new Graph(node_0);
    ...
    graph->add_new_layer();
    Node<dynamic_bitset<>>* node_3 = new Node<dynamic_bitset<>>(3, new dynamic_bitset<>(string("10000")));
    Arc<dynamic_bitset<>>* arc_1_3 = new Arc(node_1, node_3, 1);
    node_1->out_arcs.push_back(arc_1_3);
    node_3->in_arcs.push_back(arc_1_3);
    graph->add_node(node_3);

    Node<dynamic_bitset<>>* node_4 = new Node<dynamic_bitset<>>(4, new dynamic_bitset<>(string("11000")));
    ...
    graph->add_new_layer();
    Node<dynamic_bitset<>>* node_5 = new Node<dynamic_bitset<>>(5, new dynamic_bitset<>(string("10000")));
    ...
    graph->add_new_layer();
    Node<dynamic_bitset<>>* node_7 = new Node<dynamic_bitset<>>(7, new dynamic_bitset<>(string("10000")));
    Arc<dynamic_bitset<>>* arc_5_7 = new Arc(node_5, node_7, 0);
    node_5->out_arcs.push_back(arc_5_7);
    node_7->in_arcs.push_back(arc_5_7);
    ...
    Arc<dynamic_bitset<>>* arc_6_8 = new Arc(node_6, node_8, 1);
    node_6->out_arcs.push_back(arc_6_8);
    node_8->in_arcs.push_back(arc_6_8);
    graph->add_node(node_8);
    ...
    graph->add_new_layer();
    Node<dynamic_bitset<>>* node_9 = new Node<dynamic_bitset<>>(9, new dynamic_bitset<>(string("00000")));
    Arc<dynamic_bitset<>>* arc_7_9_op1 = new Arc(node_7, node_9, 0);
    node_7->out_arcs.push_back(arc_7_9_op1);
    node_9->in_arcs.push_back(arc_7_9_op1);
    Arc<dynamic_bitset<>>* arc_7_9_op2 = new Arc(node_7, node_9, 1);
    node_7->out_arcs.push_back(arc_7_9_op2);
    node_9->in_arcs.push_back(arc_7_9_op2);
    Arc<dynamic_bitset<>>* arc_8_9 = new Arc(node_8, node_9, 0);
...
Graph<dynamic_bitset<>>* GetRelaxedDDIndependentSet() {
    Node<dynamic_bitset<>>* node_0 = new Node<dynamic_bitset<>>(0, new dynamic_bitset<>(string("11111")));
    Graph<dynamic_bitset<>>* graph = new Graph(node_0);
    ...
    Node<dynamic_bitset<>>* node_4 = new Node<dynamic_bitset<>>(4, new dynamic_bitset<>(string("11100")));
    Arc<dynamic_bitset<>>* arc_2_4 = new Arc(node_2, node_4, 0);
    node_2->out_arcs.push_back(arc_2_4);
    node_4->in_arcs.push_back(arc_2_4);
    Arc<dynamic_bitset<>>* arc_1_4 = new Arc(node_1, node_4, 0);
    node_1->out_arcs.push_back(arc_1_4);
    node_4->in_arcs.push_back(arc_1_4);
    graph->add_node(node_4);
    ...
    node_5->in_arcs.push_back(arc_3_5);
    node_3->out_arcs.push_back(arc_3_5);
    Arc<dynamic_bitset<>>* arc_4_5 = new Arc(node_4, node_5, 1);
    node_5->in_arcs.push_back(arc_4_5);
    node_4->out_arcs.push_back(arc_4_5);
    graph->add_node(node_5);
...
Graph<dynamic_bitset<>>* GetFalseDDIndependentSet() {
