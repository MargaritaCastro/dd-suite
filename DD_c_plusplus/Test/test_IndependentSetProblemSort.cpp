...
#include "dd_controller_generators/DDIndependentSetSort.cpp"
...
class IndependentSetProblemTestSort : public ::testing::Test {
protected:
    void SetUp() override {
        ...
        problem_instance = new IndependentSetProblem(*independent_set_params, true);
...
TEST_F(IndependentSetProblemTestSort, TestOrderedVariables) {
    vector<string> ordered_variables_test = {"x_2", "x_3", "x_4", "x_1", "x_5"};
    ASSERT_EQ(problem_instance->ordered_variables, ordered_variables_test);
}

TEST_F(IndependentSetProblemTestSort, TestVariablesDomain) {
...
TEST_F(IndependentSetProblemTestSort, TransitionFunction) {
    auto previous_state = new dynamic_bitset<>(5, 0b11111);
    ...
    EXPECT_EQ(*scratch_state, dynamic_bitset<>(5, 0b10000));
    EXPECT_TRUE(feasibility);
    delete previous_state;
    delete scratch_state;
}

TEST_F(IndependentSetProblemTestSort, GetPriorityForDiscardNode) {
...
TEST_F(IndependentSetProblemTestSort, GetPriorityForMergeNodes) {
    auto state = new dynamic_bitset<>(5, 0b01100);
...
TEST_F(IndependentSetProblemTestSort, MergeOperator) {
...
TEST_F(IndependentSetProblemTestSort, GetStateAsString) {
...
TEST_F(IndependentSetProblemTestSort, GetStateCopy) {
    auto state = new dynamic_bitset<>(5, 0b10100);
...
TEST_F(IndependentSetProblemTestSort, GetFinalState) {
...
TEST_F(IndependentSetProblemTestSort, TestIsDDCreated) {
    dd_instance->create_decision_diagram(false);
    ASSERT_FALSE(dd_instance->get_decision_diagram()->structure.empty());
}

TEST_F(IndependentSetProblemTestSort, TestVerboseCreateDD) {
    ofstream out("createDDIndependentSetSort.txt");
    ...
    string full_file_path = source_directory + "/Test/txt_files/createDDIndependentSetSort.txt";

    ifstream file(full_file_path);
    string expected_output((istreambuf_iterator<char>(file)), istreambuf_iterator<char>());
    file.close();

    ifstream actual_file("createDDIndependentSetSort.txt");
...
TEST_F(IndependentSetProblemTestSort, TestVerboseCreateReduceDD) {
    ofstream out("createReduceDDIndependentSetSort.txt");
    streambuf *coutbuf = cout.rdbuf();
    cout.rdbuf(out.rdbuf());
    ...
    string full_file_path = source_directory + "/Test/txt_files/createReduceDDIndependentSetSort.txt";

    ifstream file(full_file_path);
    string expected_output((istreambuf_iterator<char>(file)), istreambuf_iterator<char>());
    file.close();

    ifstream actual_file("createReduceDDIndependentSetSort.txt");
    string actual_output((istreambuf_iterator<char>(actual_file)), istreambuf_iterator<char>());
    actual_file.close();
...
TEST_F(IndependentSetProblemTestSort, TestVerboseCreateRestrictedDD) {
    ofstream out("createRestrictedDDIndependentSetSort.txt");
    streambuf *coutbuf = cout.rdbuf();
    cout.rdbuf(out.rdbuf());
    ...
    string full_file_path = source_directory + "/Test/txt_files/createRestrictedDDIndependentSetSort.txt";

    ifstream file(full_file_path);
    string expected_output((istreambuf_iterator<char>(file)), istreambuf_iterator<char>());
    file.close();

    ifstream actual_file("createRestrictedDDIndependentSetSort.txt");
    string actual_output((istreambuf_iterator<char>(actual_file)), istreambuf_iterator<char>());
    actual_file.close();
...
TEST_F(IndependentSetProblemTestSort, TestVerboseCreateRelaxedDD) {
    ofstream out("createRelaxedDDIndependentSetSort.txt");
    streambuf *coutbuf = cout.rdbuf();
    cout.rdbuf(out.rdbuf());
    ...
    string full_file_path = source_directory + "/Test/txt_files/createRelaxedDDIndependentSetSort.txt";

    ifstream file(full_file_path);
    string expected_output((istreambuf_iterator<char>(file)), istreambuf_iterator<char>());
    file.close();

    ifstream actual_file("createRelaxedDDIndependentSetSort.txt");
    string actual_output((istreambuf_iterator<char>(actual_file)), istreambuf_iterator<char>());
    actual_file.close();
...
TEST_F(IndependentSetProblemTestSort, TestCreateDDGraphEqual) {
    Graph<dynamic_bitset<>>* expected_graph = GetExactDDIndependentSetSort();
    dd_instance->create_decision_diagram(false);
...
TEST_F(IndependentSetProblemTestSort, TestCreateReduceDDGraphEqual) {
    Graph<dynamic_bitset<>>* expected_graph = GetReduceDDIndependentSetSort();
    dd_instance->create_decision_diagram(false);
...
TEST_F(IndependentSetProblemTestSort, TestCreateRestrictedDDGraphEqual) {
    Graph<dynamic_bitset<>>* expected_graph = GetRestrictedDDIndependentSetSort();
...
TEST_F(IndependentSetProblemTestSort, CompareTwoDifferentGraphs) {
    Graph<dynamic_bitset<>>* not_expected_graph = GetFalseDDIndependentSetSort();
    dd_instance->create_decision_diagram(false);
...
TEST_F(IndependentSetProblemTestSort, TestCreateRelaxedDDGraphEqual) {
    Graph<dynamic_bitset<>>* expected_graph = GetRelaxedDDIndependentSetSort();
    dd_instance->create_relax_priority_decision_diagram(2, false);

    ASSERT_TRUE(*dd_instance->get_decision_diagram() == *expected_graph);
    delete expected_graph;
}

TEST_F(IndependentSetProblemTestSort, TestGetCopy) {
    dd_instance->create_decision_diagram(false);
...
TEST_F(IndependentSetProblemTestSort, TestGetDDBuilderTime) {
    dd_instance->create_decision_diagram(false);
    ASSERT_GT(stof(dd_instance->get_building_time()), 0);
}

TEST_F(IndependentSetProblemTestSort, TestGetReduceDDBuilderTime) {
    dd_instance->create_decision_diagram(false);
    dd_instance->reduce_decision_diagram();
    ASSERT_GT(stof(dd_instance->get_reduction_time()), 0);
}

TEST_F(IndependentSetProblemTestSort, TestGetRestrictedDDBuilderTime) {
    dd_instance->create_restricted_decision_diagram(2);
    ASSERT_GT(stof(dd_instance->get_building_time()), 0);
}

TEST_F(IndependentSetProblemTestSort, TestGetRelaxedDDBuilderTime) {
    dd_instance->create_relax_priority_decision_diagram(2);
    ASSERT_GT(stof(dd_instance->get_building_time()), 0);
}

TEST_F(IndependentSetProblemTestSort, GetSolutionForDD) {
    dd_instance->create_decision_diagram(false);
...
TEST_F(IndependentSetProblemTestSort, GetSolutionForReduceDD) {
    dd_instance->create_decision_diagram(false);
    dd_instance->reduce_decision_diagram();
...
TEST_F(IndependentSetProblemTestSort, GetSolutionForRestrictedeDD) {
    dd_instance->create_restricted_decision_diagram(2, false);

    PathStructureSolution solution = getLinearDpSolution();
    int expected_value = 11;
    string expected_path = " arc_0_1(0)-> arc_1_4(1)-> arc_4_6(0)-> arc_6_8(0)-> arc_8_9(1)";
    ASSERT_EQ(solution.value, expected_value);
    ASSERT_EQ(solution.path_print, expected_path);
}

TEST_F(IndependentSetProblemTestSort, GetSolutionForRelaxedeDD) {
    dd_instance->create_relax_priority_decision_diagram(2);

    PathStructureSolution solution = getLinearDpSolution();
    int expected_value = 11;
    string expected_path = " arc_0_1(0)-> arc_1_3(0)-> arc_3_5(1)-> arc_5_7(1)-> arc_7_8(1)";
    ASSERT_EQ(solution.value, expected_value);
    ASSERT_EQ(solution.path_print, expected_path);
}

TEST_F(IndependentSetProblemTestSort, TestCompareGMLDDGraph) {
    dd_instance->create_decision_diagram(false);
    dd_instance->export_graph_file("test");

    string expected_file_path = source_directory + "/Test/gml_files/exact_dd_independent_set_sort.gml";
...
TEST_F(IndependentSetProblemTestSort, TestCompareGMLReduceDDGraph) {
    dd_instance->create_decision_diagram(false);
    dd_instance->reduce_decision_diagram();
    dd_instance->export_graph_file("test");

    string expected_file_path = source_directory + "/Test/gml_files/reduce_dd_independent_set_sort.gml";
    string actual_file_path = source_directory + "/test.gml";
...
TEST_F(IndependentSetProblemTestSort, TestCompareGMLRestrictedDDGraph) {
    dd_instance->create_restricted_decision_diagram(2);
    dd_instance->export_graph_file("test");

    string expected_file_path = source_directory + "/Test/gml_files/restricted_dd_independent_set_sort.gml";
    string actual_file_path = source_directory + "/test.gml";
...
TEST_F(IndependentSetProblemTestSort, TestCompareGMLRelaxedDDGraph) {
    dd_instance->create_relax_priority_decision_diagram(2);
    dd_instance->export_graph_file("test");

    string expected_file_path = source_directory + "/Test/gml_files/relax_dd_independent_set_sort.gml";
    string actual_file_path = source_directory + "/test.gml";
