...
class SchedulerProblem(AbstractProblem):
    """
    Single-machine scheduling problem: minimise Σ w_j * C_j (weighted completion time).
    ...
    def __init__(self, params: 'SchedulerStructure', sort: bool = False):
