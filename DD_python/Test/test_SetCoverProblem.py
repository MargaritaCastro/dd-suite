...
from Test.dd_controlled_generators.DDSetCover import (
    get_exact_dd_set_cover, 
    get_relaxed_dd_set_cover, 
    get_restricted_dd_set_cover
)
...
class SetCoverTest(unittest.TestCase):
    def setUp(self):
        ...
        self.problem_instance: SetCoverProblem = SetCoverProblem(params, sort=False)
    ...
    def test_ordered_variables(self):
        ordered_variables_test: list[str] = ['conjunto_A', 'conjunto_B', 'conjunto_C', 'conjunto_D', 'conjunto_E', 'conjunto_F']
    ...
    def test_verbose_create_dd(self, mock_stdout):
        ...
        file_path: str = os.path.join('Test', 'txt_files', 'createDDSetCover.txt')
    ...
    def test_create_dd_graph_equal(self):
        self.dd_instance.create_decision_diagram(False)
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_exact_dd_set_cover())
    ...
    def test_verbose_create_reduce_dd(self, mock_stdout):
        ...
        file_path: str = os.path.join('Test', 'txt_files', 'createReduceDDSetCover.txt')
    ...
    def test_verbose_create_restricted_dd(self, mock_stdout):
        ...
        file_path: str = os.path.join('Test', 'txt_files', 'createRestrictedDDSetCover.txt')
    ...
    def test_create_restricted_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_restricted_dd_set_cover())
    ...
    def test_verbose_create_relaxed_dd(self, mock_stdout):
        ...
        file_path: str = os.path.join('Test', 'txt_files', 'createRelaxedDDSetCover.txt')
    ...
    def test_create_relaxed_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_relaxed_dd_set_cover())
    ...
    def test_get_solution_for_DD(self): 
        ...
        expected_path: str = ' arc_0_2(1)-> arc_2_6(1)-> arc_6_10(0)-> arc_10_12(0)-> arc_12_16(0)-> arc_16_17(0)'
    ...
    def test_get_solution_for_restrictedDD(self):
        ...
        expected_value: int = 3
        expected_path: str = ' arc_0_2(1)-> arc_2_5(1)-> arc_5_8(0)-> arc_8_10(0)-> arc_10_12(0)-> arc_12_14(0)'
    ...
    def test_get_solution_for_relaxedDD(self):
        ...
        expected_value: int = 3
        expected_path: str = ' arc_0_1(0)-> arc_1_3(0)-> arc_3_6(0)-> arc_6_10(1)-> arc_10_12(0)-> arc_12_14(0)'
    ...
    def test_compare_gml_exact_dd_graph(self):
        ...
        expected_file_path: str = os.path.join('Test', 'gml_files', 'exact_dd_set_cover.gml')
    ...
    def test_compare_gml_reduce_dd_graph(self):
        ...
        expected_file_path: str = os.path.join('Test', 'gml_files', 'reduce_dd_set_cover.gml')
        actual_file_path: str = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
    ...
    def test_compare_gml_restricted_dd_graph(self):
        ...
        expected_file_path: str = os.path.join('Test', 'gml_files', 'restricted_dd_set_cover.gml')
        actual_file_path: str = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
    ...
    def test_compare_gml_relax_dd_graph(self):
        ...
        expected_file_path: str = os.path.join('Test', 'gml_files', 'relax_dd_set_cover.gml')
        actual_file_path: str = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
