...
from Test.dd_controlled_generators.DDScheduler import (
    get_exact_dd_scheduler,
    get_reduce_dd_scheduler,
    get_restricted_dd_scheduler,
    get_relaxed_dd_scheduler,
    get_false_dd_scheduler,
)
...
class SchedulerProblemTest(unittest.TestCase):
    def setUp(self):
        ...
        self.problem_instance: 'AbstractProblem' = SchedulerProblem(params)
        self.dd_instance: DD = DD(self.problem_instance)

    def get_value_path_solution(self):
        solver = SchedulerPathSolver(self.dd_instance)
    ...
    def test_verbose_create_dd(self, mock_stdout):
        ...
        file_path = os.path.join('Test', 'txt_files', 'createDDScheduler.txt')
    ...
    def test_create_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_exact_dd_scheduler())
    ...
    def test_verbose_create_reduce_dd(self, mock_stdout):
        ...
        file_path = os.path.join('Test', 'txt_files', 'createReduceDDScheduler.txt')
        with open(file_path, 'r') as f:
            expected = f.read()
    ...
    def test_create_reduce_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_reduce_dd_scheduler())

    @patch('sys.stdout', new_callable=io.StringIO)
    def test_verbose_create_restricted_dd(self, mock_stdout):
        self.dd_instance.create_restricted_decision_diagram(3, verbose=True)

        file_path = os.path.join('Test', 'txt_files', 'createRestrictedDDScheduler.txt')
        with open(file_path, 'r') as f:
            expected = f.read()
    ...
    def test_create_restricted_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_restricted_dd_scheduler())
    ...
    def test_verbose_create_relaxed_dd(self, mock_stdout):
        ...
        file_path = os.path.join('Test', 'txt_files', 'createRelaxedDDScheduler.txt')
        with open(file_path, 'r') as f:
            expected = f.read()
    ...
    def test_create_relaxed_dd_graph_equal(self):
        ...
        self.assertTrue(self.dd_instance.get_decision_diagram() == get_relaxed_dd_scheduler())
    ...
    def test_compare_two_different_graphs(self):
        self.dd_instance.create_decision_diagram(False)
        self.assertFalse(self.dd_instance.get_decision_diagram() == get_false_dd_scheduler())

    def test_compare_gml_dd_graph(self):
        self.dd_instance.create_decision_diagram(False)
        self.dd_instance.export_graph_file('test')

        expected_path = os.path.join('Test', 'gml_files', 'exact_dd_scheduler.gml')
    ...
    def test_compare_gml_reduce_dd_graph(self):
        ...
        expected_path = os.path.join('Test', 'gml_files', 'reduce_dd_scheduler.gml')
        actual_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
    ...
    def test_compare_gml_restricted_dd_graph(self):
        ...
        expected_path = os.path.join('Test', 'gml_files', 'restricted_dd_scheduler.gml')
        actual_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
    ...
    def test_compare_gml_relax_dd_graph(self):
        ...
        expected_path = os.path.join('Test', 'gml_files', 'relax_dd_scheduler.gml')
        actual_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'test.gml'))
