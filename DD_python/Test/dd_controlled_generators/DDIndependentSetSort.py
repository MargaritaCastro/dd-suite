...
def get_exact_dd_independent_set_sort():
...
def get_restricted_dd_independent_set_sort():
    node_0 = Node('0', bitarray('11111'))
    graph = Graph(node_0)
    ...
    graph.add_new_layer()
    node_5 = Node('5', bitarray('00010'))
    arc_3_5 = Arc(node_3, node_5, 1)
    node_3.out_arcs.append(arc_3_5)
    node_5.in_arcs.append(arc_3_5)
    graph.add_node(node_5)
    node_6 = Node('6', bitarray('00001'))
    ...
    arc_8_9_op1 = Arc(node_8, node_9, 0)
    node_8.out_arcs.append(arc_8_9_op1)
    node_9.in_arcs.append(arc_8_9_op1)
    arc_8_9_op2 = Arc(node_8, node_9, 1)
    node_8.out_arcs.append(arc_8_9_op2)
    node_9.in_arcs.append(arc_8_9_op2)
    graph.add_node(node_9)

    return graph

def get_relaxed_dd_independent_set_sort():
    node_0 = Node('0', bitarray('11111'))
    graph = Graph(node_0)
    ...
    graph.add_new_layer()
    node_5 = Node('5', bitarray('00011'))
    arc_3_5_op2 = Arc(node_3, node_5, 1)
    node_3.out_arcs.append(arc_3_5_op2)
    node_5.in_arcs.append(arc_3_5_op2)
    arc_3_5_op1 = Arc(node_3, node_5, 0)
    node_3.out_arcs.append(arc_3_5_op1)
    node_5.in_arcs.append(arc_3_5_op1)
    graph.add_node(node_5)
    node_6 = Node('6', bitarray('00001'))
    arc_4_6 = Arc(node_4, node_6, 0)
    node_4.out_arcs.append(arc_4_6)
    ...
    arc_7_8_op1 = Arc(node_7, node_8, 0)
    node_7.out_arcs.append(arc_7_8_op1)
    node_8.in_arcs.append(arc_7_8_op1)
    arc_7_8_op2 = Arc(node_7, node_8, 1)
    node_7.out_arcs.append(arc_7_8_op2)
    node_8.in_arcs.append(arc_7_8_op2)
    graph.add_node(node_8)
